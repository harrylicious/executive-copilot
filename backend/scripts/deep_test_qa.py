"""Deep testing script for questions-answers.json against the /api/chat endpoint.
...
QA_FILE = Path(__file__).parent.parent / "json" / "questions-answers.json"
...
report_file = Path(__file__).parent.parent / "_qa_test_report.json"
