"""Deep testing script for questions-answers3.json against the /api/chat endpoint.
...
QA_FILE = Path(__file__).parent.parent / "json" / "questions-answers3.json"
...
report_file = Path(__file__).parent.parent / "_qa3_test_report.json"
